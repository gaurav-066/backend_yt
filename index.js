...
app.get('/search', (req, res) => {
            ...
            const safe = query.replace(/[;"'`$\\|&<>]/g, '');
              const cmd = `yt-dlp "ytsearch1:${safe}" --get-id --get-title --get-duration --no-playlist -q ${cookieArg} --extractor-args "youtube:player_client=mediaconnect,default"`;
...
app.get('/stream', (req, res) => {
            ...
            const cmd = `yt-dlp "https://youtube.com/watch?v=${id}" -f bestaudio -g ${cookieArg} --extractor-args "youtube:player_client=mediaconnect,default"`;
              exec(cmd, { timeout: 30000 }, (err, stdout, stderr) => {
